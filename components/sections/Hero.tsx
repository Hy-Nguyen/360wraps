...
import BGImage from '@/public/img/HeroSplash.jpg';
...
export default function Hero() {
  return (
    <section
      id="hero"
      className="flex h-[100dvh] bg-hero w-[100dvw] max-w-[100dvw] flex-col items-start justify-center bg-black lg:w-screen lg:max-w-[100vw] lg:justify-center"
    >
      {/* <Image
        src={BGImage}
        alt="Background"
        className="absolute bg-local left-1/2 h-full w-[100dvw] -translate-x-1/2 object-cover"
      /> */}
